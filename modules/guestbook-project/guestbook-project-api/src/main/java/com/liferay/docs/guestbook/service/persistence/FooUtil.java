 ...
 * @see FooPersistence
 * @see com.liferay.docs.guestbook.service.persistence.impl.FooPersistenceImpl
 * @generated
 */
@ProviderType
public class FooUtil {
	...
	*/
	public static Foo findByUuid_First(String uuid,
		OrderByComparator<Foo> orderByComparator)
		throws com.liferay.docs.guestbook.exception.NoSuchFooException {
	...
	*/
	...
	static {
		...
		ServiceTracker<FooPersistence, FooPersistence> serviceTracker = new ServiceTracker<FooPersistence, FooPersistence>(bundle.getBundleContext(),
